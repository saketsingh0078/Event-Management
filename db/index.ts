...
export function getDb() {
  ...
  if (!connectionString) {
    throw new Error("DATABASE_URL environment variable is not set. Please configure your database connection in .env.local");
  }
  ...
  if (!connection) {
    ...
    try {
      ...
      throw new Error("Invalid DATABASE_URL format. Please use the format: postgres://user:password@host:port/database");
    }
